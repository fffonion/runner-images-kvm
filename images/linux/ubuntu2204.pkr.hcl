...
build {
  ...
  provisioner "shell" {
    ...
    scripts          = [
                        ...
                        # UNSUPPORTED "${path.root}/scripts/installers/microsoft-edge.sh",
                        ...
                        "${path.root}/scripts/installers/golang.sh",
                        # UNSUPPORTED "${path.root}/scripts/installers/google-chrome.sh",
                        ...
                        # APT DEPENDENCY BROKEN "${path.root}/scripts/installers/julia.sh",
