...
build {
  ...
  provisioner "shell" {
    ...
    scripts          = [
                        ...
                        // UNSUPPORTED "${path.root}/../scripts/build/microsoft-edge.sh",
                        ...
                        // UNSUPPORTED "${path.root}/../scripts/build/google-chrome.sh",
                        ...
                        // APT DEPENDENCY BROKEN  "${path.root}/../scripts/build/julia.sh",
